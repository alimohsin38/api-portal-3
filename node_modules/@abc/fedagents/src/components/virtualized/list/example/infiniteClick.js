...
export default class InfiniteClickListExample extends Component {
    constructor(props) {
        super(props)
        ...
        this.state = {
            count: 10,
            loading: false,
            options: range(10).map(makeNewListItem(0)),
        }

        this.loadMore = this.loadMore.bind(this)
        this.loadNoResults = this.loadNoResults.bind(this)
    ...
    render() {
        return (
            <div>
                ...
                <Divider />
                <Button size="sm" btnStyle="secondary" onClick={this.loadMore}>Load More Items</Button>
                <Button size="sm" btnStyle="secondary" onClick={this.resetItems}>Reload Items</Button>
                <Button size="sm" btnStyle="secondary" onClick={this.loadNoResults}>No Results</Button>
            </div>
        )
    }
}
