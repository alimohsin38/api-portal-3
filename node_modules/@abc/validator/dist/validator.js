...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_get_iterator__ = __webpack_require__(15);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__common__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__metadata__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__format__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__get_number_type__ = __webpack_require__(14);
...
var countryLookup = exports.countryLookup = {
...
var postalCodeRegExp = exports.postalCodeRegExp = {
...
var countryNameLookup = exports.countryNameLookup = function countryNameLookup(country) {
    var normalizedCountry = (country || '').replace(/\s\s+/g, ' ').trim().toLowerCase();
    var foundCountry = void 0;

    if (normalizedCountry.length === 2) {
        Object.keys(countryLookup).some(function (countryName) {
...
var countryCodeLookup = exports.countryCodeLookup = function countryCodeLookup(country) {
    var type = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'twoLetter';

    var foundCountry = countryNameLookup(country);
    var countryCodes = foundCountry ? countryLookup[foundCountry.toLowerCase()] : undefined;
    return countryCodes ? countryCodes[type] : undefined;
};

var countryHasTerritories = exports.countryHasTerritories = function countryHasTerritories(country) {
    return !!territoryOptions[countryNameLookup(country)];
};

var territoryLabelForCountry = exports.territoryLabelForCountry = function territoryLabelForCountry(country) {
    return territoryLabels[countryNameLookup(country)] || '';
};

var territoryOptionsForCountry = exports.territoryOptionsForCountry = function territoryOptionsForCountry(country) {
    return territoryOptions[countryNameLookup(country)] || {};
};
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__common__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__metadata__ = __webpack_require__(3);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__parse__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__get_number_type__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__metadata__ = __webpack_require__(3);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_get_iterator__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_get_iterator___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_get_iterator__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_classCallCheck__ = __webpack_require__(75);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_classCallCheck___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_classCallCheck__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_createClass__ = __webpack_require__(76);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_createClass___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_createClass__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__metadata__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__parse__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__format__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__common__ = __webpack_require__(12);
...
var _inputmaskCore = __webpack_require__(84);

var _inputmaskCore2 = _interopRequireDefault(_inputmaskCore);

var _keyboard = __webpack_require__(85);
...
var setSelection = function setSelection(input, selection) {
    input.focus();
    input.setSelectionRange(selection.start, selection.end);
};

var removePlaceholderCharacters = function removePlaceholderCharacters(value, placeholderCharacters) {
    return value.split('').reduce(function (accumulated, currentCharacter, currentIndex) {
        return accumulated.length === currentIndex && !placeholderCharacters.includes(currentCharacter) ? '' + accumulated + currentCharacter : accumulated;
    }, '');
};
...
var MaskedInput = function () {
    function MaskedInput(options) {
        ...
        var inputMask = new _inputmaskCore2.default(_extends({}, options));
    ...
    _createClass(MaskedInput, [{
        ...
        value: function updateMaskSelection(input) {
            var inputMask = inputMasks.get(this);
            inputMask.selection = getSelection(input);
            return Promise.resolve(inputMask.selection);
        }
    }, {
        key: 'updateInputSelection',
        value: function updateInputSelection(input) {
            var inputMask = inputMasks.get(this);
        ...
        value: function getInputSelection(input) {
            ...
            var value = input.value.slice(0, selection.end);
            for (var i = selection.end, l = selection.start; i >= l; i--) {
        ...
        value: function handleCut(event) {
            var inputMask = this && this.mask;
            if (event && inputMask) {
                this.updateMaskSelection(event.target);
                if (event.clipboardData) {
                    var cutData = this.getInputSelection(event.target);
        ...
        value: function handlePaste(event) {
            ...
            if (event && inputMask) {
                this.updateMaskSelection(event.target);
                if (event.clipboardData) {
                    var pasteData = event.clipboardData.types && event.clipboardData.types['text/plain'] ? event.clipboardData.getData('text/plain') : event.clipboardData.getData('Text');
                    if (inputMask.selection.start < inputMask.pattern.firstEditableIndex) {
                        for (var i = inputMask.pattern.firstEditableIndex - 1, l = inputMask.selection.start; i >= l; i--) {
            ...
            if (event && inputMask) {
                if (event.key === 'Backspace') {
                    ...
                    if (this.selection.end === this.selection.start) {
                        var i = inputMask.selection.start - 1;
                ...
                if (_keyboard2.default.isUndo(event) && inputMask.undo() || _keyboard2.default.isRedo(event) && inputMask.redo()) {
                    event.preventDefault();
                    this.updateInputSelection(event.target);
                }
            }
        ...
        value: function handleInput(event) {
            if (event && this && this.mask) {
                var maskValue = this.displayValue;
        ...
        get: function get() {
            ...
            var i = this.mask.pattern.firstEditableIndex;
            while (i <= value.length && (!this.mask.pattern.isEditableIndex(i) || value.charAt(i) !== this.mask.placeholderChar)) {
                i++;
            }
            return i;
        }
        ...
        set: function set(value) {
            ...
            var newValue = this.revealedValue;
...
var _email = __webpack_require__(39);
...
var _phone = __webpack_require__(40);
...
var _postalCode = __webpack_require__(80);

Object.defineProperty(exports, 'validatePostalCode', {
    enumerable: true,
    get: function get() {
        return _interopRequireDefault(_postalCode).default;
    }
});
Object.defineProperty(exports, 'validateZipCode', {
    enumerable: true,
    get: function get() {
        return _postalCode.validateZipCode;
    }
});
...
var _territory = __webpack_require__(82);

Object.defineProperty(exports, 'validateTerritory', {
    enumerable: true,
    get: function get() {
        return _interopRequireDefault(_territory).default;
    }
});
Object.defineProperty(exports, 'validateState', {
    enumerable: true,
    get: function get() {
        return _territory.validateState;
    }
});
...
var _phone2 = __webpack_require__(86);

Object.defineProperty(exports, 'MaskedPhoneInput', {
    enumerable: true,
    get: function get() {
        return _interopRequireDefault(_phone2).default;
    }
});

var _address = __webpack_require__(4);

Object.defineProperty(exports, 'countryNameLookup', {
    enumerable: true,
    get: function get() {
        return _address.countryNameLookup;
    }
});
Object.defineProperty(exports, 'countryCodeLookup', {
    enumerable: true,
    get: function get() {
        return _address.countryCodeLookup;
    }
});
Object.defineProperty(exports, 'countryHasTerritories', {
    enumerable: true,
    get: function get() {
        return _address.countryHasTerritories;
    }
});
Object.defineProperty(exports, 'territoryLabelForCountry', {
    enumerable: true,
    get: function get() {
        return _address.territoryLabelForCountry;
    }
});
Object.defineProperty(exports, 'territoryOptionsForCountry', {
    enumerable: true,
    get: function get() {
        return _address.territoryOptionsForCountry;
    }
});
...
var _libphonenumberJs = __webpack_require__(41);

var validatePhone = function validatePhone(value) {
    var country = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'US';
    return (0, _libphonenumberJs.isValidNumber)({
        phone: value,
        country: (0, _address.countryCodeLookup)(country)
    });
};
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__metadata_min_json__ = __webpack_require__(42);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__es6_parse__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__es6_get_number_type__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__es6_format__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__es6_validate__ = __webpack_require__(34);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__es6_as_you_type__ = __webpack_require__(35);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__es6_metadata__ = __webpack_require__(3);
...
exports.validateZipCode = undefined;

var _address = __webpack_require__(4);

var validatePostalCode = function validatePostalCode(value, country) {
    var response = false;

    if (value && value.trim() !== '') {
        var countryCode = (0, _address.countryCodeLookup)(country);

        if (countryCode && countryCode in _address.postalCodeRegExp) {
            response = _address.postalCodeRegExp[countryCode].test(value);
        } else {
            response = Object.keys(_address.postalCodeRegExp).some(function (key) {
                return _address.postalCodeRegExp[key].test(value.trim());
            });
        }
    }
...
var validateZipCode = exports.validateZipCode = function validateZipCode(value) {
    return validatePostalCode(value, 'US');
};

exports.default = validatePostalCode;
...
exports.validateState = undefined;

var _address = __webpack_require__(4);

var validateTerritory = function validateTerritory(value, country) {
    var response = false;

    if (value && value.trim() !== '') {
        var territories = (0, _address.territoryOptionsForCountry)(country);
        response = !!territories[value] || Object.keys(territories).some(function (key) {
            return territories[key] === value.trim();
        });
    }
...
var validateState = exports.validateState = function validateState(value) {
    return validateTerritory(value, 'US');
};

exports.default = validateTerritory;
...
exports.default = {
    isCut: function isCut(event) {
        return (event.ctrlKey || event.metaKey) && event.keyCode === KEYCODE_X;
    },
    isPaste: function isPaste(event) {
        return (event.ctrlKey || event.metaKey) && event.keyCode === KEYCODE_V;
    },
    isUndo: function isUndo(event) {
        return (event.ctrlKey || event.metaKey) && event.keyCode === (event.shiftKey ? KEYCODE_Y : KEYCODE_Z);
    },
    isRedo: function isRedo(event) {
...
var _castArray = __webpack_require__(87);
...
var phoneCountry = new WeakMap();

var MaskedPhoneInput = function (_MaskedInput) {
    _inherits(MaskedPhoneInput, _MaskedInput);

    function MaskedPhoneInput(country) {
        _classCallCheck(this, MaskedPhoneInput);

        var _this = _possibleConstructorReturn(this, (MaskedPhoneInput.__proto__ || Object.getPrototypeOf(MaskedPhoneInput)).call(this, {
            pattern: '1111111111'
        }));

        _this.country = country || 'US';
        return _this;
    }

    _createClass(MaskedPhoneInput, [{
        key: 'country',
        set: function set(value) {
            var newCountry = (0, _address.countryCodeLookup)(value);
            phoneCountry.set(this, newCountry);
            var masks = (0, _castArray2.default)(newCountry && countryPhoneMasks[newCountry]);
...
exports.default = MaskedPhoneInput;
